...
const (
	PaymentsService_ProcessPayment_FullMethodName    = "/payments.PaymentsService/ProcessPayment"
	PaymentsService_GetPaymentByOrder_FullMethodName = "/payments.PaymentsService/GetPaymentByOrder"
)
